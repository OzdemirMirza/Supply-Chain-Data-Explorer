-- Bu dosya, tablolarımıza başlangıç verilerini ekler.


-- 1. Ana tabloları doldur
-- Mevcut veriler
...
-- YENİ EKLENEN MÜŞTERİLER
INSERT INTO Musteri (musteriAdi, musteriSoyadi) VALUES
('Hasan', 'Çelik'),
('Elif', 'Aksoy');


-- 2. İlişki tablolarını doldur (Katalog)
-- Mevcut veriler
...
-- YENİ EKLENEN KATALOG KAYITLARI
INSERT INTO Katalog (tedarikciNo, parcaNo, fiyat) VALUES
